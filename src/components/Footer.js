...
import SonoroLogo from '../../src/logo_Sonoro.svg';
import ArticLogo from '../../src/articfox.svg';
        ...
        <section style={{backgroundColor:'#46bfd7'}}>
            <div className="max-w-screen-xl  md:py-12 px-4 py-8 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                <div className="flex justify-center  space-x-6">
                    ...
                    <a href="https://www.facebook.com/QueFuePodcast" target="_blank" className="text-white">
                        <svg className="w-8 h-8" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                            <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd"></path>
                        </svg>
                    </a>
                    <a href="https://www.youtube.com/c/Quefuedeellos" target="_blank" className="text-white">
                ...
                <div className="w-full flex justify-around items-center">
                    <a href="https://sonoromedia.com/">
                        <img className="h-10 " src={SonoroLogo} />
                    </a>
                    <a href="https://sonoromedia.com/">
                        <img className="h-16 " src={ArticLogo} />
                    </a>
                </div>
                <p className=" text-base  text-center text-white">
                    © 2021 SinContexto producciones, Inc. All rights reserved. <br/>
