                    ...
                    <Bounce right>
                        <div className="sm:w-1/2 p-6 sm-text-center">
                            ...
                            <div className="flex justify-center md:justify-start mt-4 space-x-6">
                                <a href="https://www.instagram.com/quefuepodcast/?hl=es" target="_blank" className="text-black">
                                ...
                                <a href="https://www.facebook.com/QueFuePodcast" target="_blank" className="text-black">
                                    <svg className="w-8 h-8" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
